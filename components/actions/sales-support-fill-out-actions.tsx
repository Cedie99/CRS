...
export function SalesSupportFillOutActions({
  cisId,
  initialOtherDocs = [],
}: SalesSupportFillOutActionsProps) {
    ...
    <Card className="print:hidden overflow-hidden border border-emerald-200/70 bg-linear-to-b from-emerald-50/60 via-white to-white shadow-sm">
      ...
      <CardContent className="space-y-5 pt-5">
            ...
            {[
              ...
              >
                <input
                  ...
                  disabled={isLoading}
                  className="h-4 w-4 accent-[#2d6e1e]"
                />
                <span>{opt.label}</span>
              </label>
            ))}
        ...
        <div className="flex flex-col gap-2 border-t border-zinc-200 pt-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-zinc-500">All five required fields must be completed before submission.</p>
          <Button
