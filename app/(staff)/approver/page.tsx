    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="rounded-xl border border-zinc-100 bg-white p-4 shadow-sm">
          ...
          <p className="mt-0.5 text-xs text-zinc-400">awaiting decision</p>
        ...
        <div className="rounded-xl border border-zinc-100 bg-white p-4 shadow-sm">
          ...
          <p className="mt-1 text-3xl font-bold text-zinc-900">{approved}</p>
          <p className="mt-0.5 text-xs text-zinc-400">{total > 0 ? `${pct(approved)}% of processed` : "none yet"}</p>
          <div className="mt-3 h-1 w-full rounded-full bg-zinc-100">
